// IP ที่ห้ามเข้าเว็บตลอดไป (Blacklist)
const BLACKLISTED_IP = "49.228.244.3";
...
async function banIP() {
    ...
    // ❌ บล็อก IP "49.228.244.3" ตลอดไป
    if (ip === BLACKLISTED_IP) {
        document.body.innerHTML = `<h1>😂 เครื่องนี้เข้าไม่ได้ตลอดไป 555+ 🚫</h1>`;
        return;
    }
